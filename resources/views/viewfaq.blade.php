...
<div class="page-btn">
<a href="/addfaq" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img">Add FAQ</a>
</div>
</div>
...
<td>{{$s->title}}</td>
<td><p style="text-wrap: wrap;width:30rem; display:block;">{{$s->description}}</p></td>
