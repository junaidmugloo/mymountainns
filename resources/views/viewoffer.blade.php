...
<div class="page-btn">
<a href="/addoffer" class="btn btn-added"><img src="assets/img/icons/plus.svg" class="me-2" alt="img">Add Offer</a>
</div>
</div>
...
<td>
<a class="product-img">
<img src="offer_images/{{$s->image}}" alt="product">
</a>
</td>
<td>{{$s->heading}}</td>
<td>{{$s->description}}</td>
...
<a class="me-3" href="/editoffer/{{$s->id}}">
