                ...
                <div class="header-main">
                    <div class="logo">
                        <a href="{{ url("index.html") }}" class="header-logo">
                            <img src="{{ asset("mymountains/assets/img/logo/solutions.png") }}" width="260" alt="logo-img">
                        </a>
                        <div class="logo-2">
                            <a href="{{ url("index.html") }}">
                                <img src="{{ asset("mymountains/assets/img/logo/solutions.png") }}" width="260" alt="">
                            </a>
                        </div>
                    </div>
  ...
  <div class="tab-content" id="myTabContent">
              ...
              <div class="col-12">
                <div class="form-group mb-3">
                  ...
                  <small id="password-err1" class="text-danger"></small>
                    ...
                    <b style="color: var(--primary-color, #46bfaf) !important; text-align:end;" class="pb-2">Forgot Password?</b>

              <div class="col-12">
                <div class="form-group mb-3">
                  <button id="loginnn" type="submit"  style="background:#46bfaf;" class="btn text-light d-block w-100">
    ...
    <form  novalidate id="user_signup" style=" justify-content: center;
            ...
            <div class="col-12">
              ...
              <div class="col-12">
                <div class="form-group mb-3">
                  <button id="loginn"  type="submit" style="background:#46bfaf;" class="btn text-light d-block w-100">
                    Signup</button>
                </div>
              </div>
            </div>
