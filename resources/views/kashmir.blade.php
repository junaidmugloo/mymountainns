        ...
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".6s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/03.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".8s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/04.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".2s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/05.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".4s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/06.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".6s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/07.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp wow" data-wow-delay=".8s">
                    <div class="destination-card-items mt-0">
                        <div class="destination-image">
                            <img src="{{ asset("/mymountains/assets/img/destination/08.jpg") }}" alt="img">
                            <div class="heart-icon">
                                <i class="fa-regular fa-heart"></i>
                            </div>
                        </div>
