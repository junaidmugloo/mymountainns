...
<label>Heading</label>
<input type="text" value="{{$package->heading}}" name="name" required placeholder="Enter package name">
</div>
</div>
...
<div class="col-lg-6 col-sm-6 col-6">
    ...
    <input type="text" value="{{$package->link}}"  name="link" placeholder="Contact number">
    </div>
</div>
