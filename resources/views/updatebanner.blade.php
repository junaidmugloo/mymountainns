...
<input type="color" name="heading_color" value="{{$slider->heading_color}}">
...
<input type="text" name="offer_line" value="{{$slider->offer_line}}">
<input type="color" name="offer_line_color" value="{{$slider->offer_line_color}}">
</div>
</div>
<div class="col-lg-6 col-sm-6 col-12">
  <div class="form-group">
  <label>Tag Line</label>
  <input type="text" name="tag_line" value="{{$slider->tag_line}}">
  </div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Price</label>
<input type="text" name="price" value="{{$slider->price}}">
</div>
</div>
<div class="col-lg-3 col-sm-6 col-12">
<div class="form-group">
<label>Discount Price</label>
<input type="text"  name="discount_price" value="{{$slider->discount}}">
</div>
</div>
<div class="col-lg-12">
<div class="form-group">
...
<script>
  ...
  confirmButtonText: 'OK'
      ...
      if (result.isConfirmed) {
          window.location.href = '/viewbanner';
      } else {
        window.location.href = '/viewbanner';
      }
  });
